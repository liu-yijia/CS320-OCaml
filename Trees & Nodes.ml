...
Example: map_tree (fun _ -> 0) (Node (Node (Leaf true, Node (Leaf true, Leaf false)), Node (Node (Leaf true, Node (Leaf true, Leaf false)), Leaf false))) =
...
Example: fold_tree (+) (fun _ -> 1) (Node (Node (Leaf true, Node (Leaf true, Leaf false)), Node (Node (Leaf true, Node (Leaf true, Leaf false)), Leaf false))) = 7 *)
...
Example: sum_ints (Node (Leaf 1, Leaf 2)) = 3 *)
...
Example: tree_size (Node (Leaf 1, Leaf 2)) = 3 *)
...
Example: tree_height (Node ((Node (Leaf 1, (Node ((Node (Leaf 1, Leaf 2)), Leaf 2)))), Leaf 2)) = 5 *)
...
Example: tree_contains (Node (Leaf 1, (Node ((Node (Leaf 1, Leaf 2)), Leaf 2)))) (fun x -> tree_height x > 2) = true *)
...
Example: show_bool_tree (Node (Node (Leaf true, Node (Leaf true, Leaf false)), Node (Node (Leaf true, Node (Leaf true, Leaf false)), Leaf false))) =
...
(* a fubction that reads bool trees : for all (finite) t : bool trees.read_bool_tree t = Some (show_bool_tree t)
Example: read_bool_tree "((true^(true^false))^((true^(true^false))^false))" = Some (Node (Node (Leaf true, Node (Leaf true, Leaf false)),
...
(* a function that checks that parenthisis are balnaced:
